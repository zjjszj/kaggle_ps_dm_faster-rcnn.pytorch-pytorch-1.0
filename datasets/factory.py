...
__sets = {}
from mydetector.datasets.pascal_voc import pascal_voc
from mydetector.datasets.coco import coco
from mydetector.datasets.imagenet import imagenet
from mydetector.datasets.vg import vg
